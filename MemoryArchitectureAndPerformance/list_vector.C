...
BENCHMARK_TEMPLATE(BM_read_vector, unsigned long) ARGS; 
BENCHMARK_TEMPLATE(BM_read_list, unsigned long) ARGS; 
BENCHMARK_TEMPLATE(BM_write_vector, unsigned long) ARGS; 
BENCHMARK_TEMPLATE(BM_write_list, unsigned long) ARGS; 
BENCHMARK_MAIN(); 

// g++ list_vector.C -lbenchmark -mavx2 -o list_vector && ./list_vector